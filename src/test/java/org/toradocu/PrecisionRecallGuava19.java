...
public class PrecisionRecallGuava19 extends AbstractPrecisionRecallTestSuite {
  ...
  public void testArrayListMultimap() throws Exception {
    test("com.google.common.collect.ArrayListMultimap", 1, 1, 1, 1, 0, 0);
  }

  @Test
  public void testCharMatcher() throws Exception {
    test("com.google.common.base.CharMatcher", 0, 0, 1, 0, 0, 0);
  }

  @Test
  public void testConverter() throws Exception {
    test("com.google.common.base.Converter", 1, 1, 1, 1, 0, 0);
  }

  @Test
  public void testSplitter() throws Exception {
    test("com.google.common.base.Splitter", 1, 1, 1, 0, 0, 0);
  }

  @Test
  public void testThrowables() throws Exception {
    test("com.google.common.base.Throwables", 1, 1, 1, 0, 0, 0);
  }

  @Test
  public void testCacheLoader() throws Exception {
    test("com.google.common.cache.CacheLoader", 1, 1, 1, 0, 0, 0);
  }

  @Test
  public void testIterators() throws Exception {
    test("com.google.common.collect.Iterators", 1, 0.6, 1, 1, 0, 0);
  }
  ...
  public void testHashing() throws Exception {
    test("com.google.common.hash.Hashing", 1, 0, 1, 0, 0, 0);
  }

  @Test
  public void testConcurrentHashMultiset() throws Exception {
    test("com.google.common.collect.ConcurrentHashMultiset", 0.818, 0.692, 1, 1, 0, 0);
  }

  @Test
  public void testDoubles() throws Exception {
    test("com.google.common.primitives.Doubles", 0.75, 0.75, 1, 0, 0, 0);
  }

  @Test
  public void testFloats() throws Exception {
    test("com.google.common.primitives.Floats", 0.75, 0.75, 1, 1, 0, 0);
  }
  ...
  public void testShorts() throws Exception {
    test("com.google.common.primitives.Shorts", 0.75, 0.5, 1, 0, 0, 0);
  }
  ...
  public void testVerify() throws Exception {
    test("com.google.common.base.Verify", 1, 1, 1, 1, 0, 0);
  }

  @Test
  public void testAtomicDoubleArray() throws Exception {
    test("com.google.common.util.concurrent.AtomicDoubleArray", 1, 1, 1, 1, 0, 0);
  }
}
