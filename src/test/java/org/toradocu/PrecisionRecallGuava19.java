...
public class PrecisionRecallGuava19 extends AbstractPrecisionRecallTestSuite {
  ...
  public void testCharMatcher() throws Exception {
    test("com.google.common.base.CharMatcher", 0, 0, 1, 0);
  }

  @Test
  public void testConverter() throws Exception {
    test("com.google.common.base.Converter", 1, 1, 1, 1);
  }

  @Test
  public void testSplitter() throws Exception {
    test("com.google.common.base.Splitter", 1, 1, 1, 0);
  }

  @Test
  public void testThrowables() throws Exception {
    test("com.google.common.base.Throwables", 1, 1, 1, 0);
  }

  @Test
  public void testCacheLoader() throws Exception {
    test("com.google.common.cache.CacheLoader", 1, 1, 1, 0);
  }

  @Test
  public void testIterators() throws Exception {
    test("com.google.common.collect.Iterators", 1, 0.6, 1, 1);
  }

  @Test
  public void testBloomFilter() throws Exception {
    test("com.google.common.hash.BloomFilter", 1, 0.5, 0.777, 0.777);
  }

  @Test
  public void testHashing() throws Exception {
    test("com.google.common.hash.Hashing", 1, 0, 1, 0);
  }
