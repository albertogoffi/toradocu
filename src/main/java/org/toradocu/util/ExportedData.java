...
public class ExportedData {
	...
	/**
	 * Constructs an {@code ExportedData} with data to export initialized from the given collection
	 * of {@code DocumentedMethod}s.
	 * 
	 ...
	 * nullness constraints along with any that have translated throws tags. Also adds the
	 * translated throws tags contained in the methods.
	 * 
	 * @param methods a collection of methods
	 */
