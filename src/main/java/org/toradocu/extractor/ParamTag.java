...
/**
 * This class represents a param tag in a method. Each param tag consist of the name of the param and a brief description, which may contain
 * a condition. A condition is the translation of the comment into a
...
public class ParamTag {
	...
	/**
	  ...
	  /**
	   * Returns a string representation of this param tag. The returned string is in the format
	   * "@param PARAMNAME COMMENT" where PARAMNAME is the fully qualified name of the parameter in the param tag
	   *  and COMMENT is the text of the comment in the param tag. If translation has
	   * been attempted on this tag, then the returned string is also appended with " ==&gt; CONDITION"
	   * where CONDITION is the translated condition as a Java expression or the empty
