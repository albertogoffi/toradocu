...
/**
 * This class represents a class code element for use in translation. It holds String identifiers for the
 * class and a Java expression representation of the class to build Java conditions.
 */
public class ClassCodeElement extends CodeElement<Class<?>> {
	...
	/**
	 * Builds and returns the string "target" as the Java expression representation of this
	 * parameter code element.
	 * 
	 * @return the string "target" as the Java expression representation of this parameter code element
	 */
	@Override
