...
/**
 * This class represents a general code element for use in translation. It holds the String identifiers and
 * Java expression representation specified by the client.
 */
public class GeneralCodeElement extends CodeElement<String> {

	/**
	 * Constructs and initializes a code element with the given identifiers and the given
	 * Java expression representation.
	 * 
