 ...
 * "PROPOSITION_A CONJUNCTION_AB PROPOSITION_B CONJUNCTION_BC PROPOSITION_C ...". It provides methods
 * to retrieve propositions and conjunctions between propositions.
 */
public class PropositionSeries {
	...
	/**
	 * Adds a conjunction and proposition to the series. The conjunction links the formerly last proposition in the
