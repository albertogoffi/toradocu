...
/**
 * This class represents a proposition about Java code. It consists of a subject, predicate,
 * and a translation of the proposition into a Java expression.
 */
public class Proposition {
	 ...
	 * @param subject the subject of the proposition
	 * @param predicate the predicate associated with the subject
	 * @param isNegative true if this Proposition is the negation of the given predicate, false otherwise
	 */
	...
	/**
	 * Returns the predicate of the proposition, not taking into account whether this proposition is negated.
	 * 
	...
	public boolean equals(Object obj) {
		...
		boolean result = subject.equals(that.subject) && predicate.equals(that.predicate)
	...
	/**
	 * Returns a String representation of this proposition. The returned String is formatted
	 * as "(SUBJECT, PREDICATE) -> TRANSLATION", or if no translation is present, "(SUBJECT, PREDICATE)".
