...
package org.toradocu.doclet.formats.html.markup;
...
public class HtmlWriter {
  ...
  public HtmlWriter(Configuration configuration, DocPath path)
    ...
    profileTableHeader =
        new String[] {
          configuration.getText("doclet.Profile"), configuration.getText("doclet.Description")
        };
    packageTableHeader =
        new String[] {
          configuration.getText("doclet.Package"), configuration.getText("doclet.Description")
        };
    useTableSummary =
        configuration.getText("doclet.Use_Table_Summary", configuration.getText("doclet.packages"));
    modifierTypeHeader =
  ...
  public Content getResource(String key, Object o1, Object o2) {
    return configuration.getResource(key, o1, o2);
  }
    ...
    if (winTitle != null && winTitle.length() > 0) {
      ...
      String scriptCode =
          "<!--"
              ...
              + escapeJavaScriptChars(winTitle)
              + "\";"
              + DocletConstants.NL
              + "        }"
              + DocletConstants.NL
   ...
   */
  public void generateMethodTypesScript(
      Map<String, Integer> typeMap, Set<MethodTypes> methodTypes) {
    String sep = "";
